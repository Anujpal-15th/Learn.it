...
export const TOPIC_META = {
  ...
  'core-java': { difficulty: 'BEGINNER', estimatedTime: '6–8 hrs', prerequisites: ['programming-foundations'] },
  'ood-foundations': { difficulty: 'INTERMEDIATE', estimatedTime: '5–6 hrs', prerequisites: ['core-java'] },
  ...
  'dsa1': { difficulty: 'BEGINNER', estimatedTime: '10–12 hrs', prerequisites: ['core-java'] },
  ...
  'production-engineering-capstone': { difficulty: 'INTERMEDIATE', estimatedTime: '6–8 hrs', prerequisites: ['testing', 'concurrency-jvm'] },
  ...
  'lld-design-patterns': { difficulty: 'ADVANCED', estimatedTime: '10–12 hrs', prerequisites: ['production-engineering-capstone'] },
