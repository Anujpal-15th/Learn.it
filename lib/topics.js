...
//
// Shapes (Architecture.md, extended per user-directed content overhaul):
//   PHASES:         [{ name, desc }]                (8, Phase 0..7)
//   TOPICS:         [{ id, num, phase, title, sub, subtopics, mini }]  (27)
...
//       - learnMore: one optional deeper-reading link.
//       - d = 'E'|'M'|'H'
//     mini:         { title, desc }                 checkpoint project
//   PHASE_PROJECTS: [{ title, desc }]               (8, one per phase)
//   CAPSTONE:       { title, desc }
//
// DSA (Phase 0) is restructured around the real, industry-standard 18-pattern
// breakdown (NeetCode 150 / Blind 75 taxonomy, verified live against
// neetcode.io) grouped into 6 topics. Real, well-known LeetCode problems get
// correct URLs — verified via web search/fetch where the problem is less
// common, not just recalled. A small number of canonical patterns (e.g.
// Meeting Rooms) are premium-locked on LeetCode; those are marked as
// "Build task" instead of linking a paywalled problem, per Rules.md.
// Framework/infra/frontend work uses concrete "Build task" exercises with no
// invented links. Java fundamentals uses verified-real HackerRank Java-domain
// challenge slugs.
...
export const TOPICS = [
  ...
  // Blind 75), grouped into 6 topics so prerequisite patterns come first.
  // ==================================================================
  {
    id: 'dsa1', num: 1, phase: 0, title: 'DSA I — Arrays, Two Pointers & Sliding Window',
  ...
  {
    id: 'dsa2', num: 2, phase: 0, title: 'DSA II — Stack, Binary Search & Linked List',
  ...
  {
    id: 'dsa3', num: 3, phase: 0, title: 'DSA III — Trees, Heaps & Tries',
    ...
    subtopics: [
      ...
      { title: 'Tries',
        concepts: [
          ...
          'This is a small pattern (3 canonical problems), but it underpins real features like autocomplete, spell-check, and IP routing tables.',
        ],
  ...
  {
    id: 'dsa4', num: 4, phase: 0, title: 'DSA IV — Backtracking & Graphs',
  ...
  {
    id: 'dsa5', num: 5, phase: 0, title: 'DSA V — Advanced Graphs & Dynamic Programming',
  ...
  {
    id: 'dsa6', num: 6, phase: 0, title: 'DSA VI — Greedy, Intervals, Math & Bit Manipulation',
    ...
    subtopics: [
      ...
      { title: 'Intervals',
        concepts: [
          ...
          'Merging, inserting, and counting overlaps are the three core interval operations; scheduling/meeting-room problems are all variations on counting overlaps.',
        ],
  ...
  // ==================================================================
  {
    id: 'java-fundamentals', num: 7, phase: 1, title: 'Java Fundamentals — Syntax & OOP Basics',
    sub: "Before Collections, Streams, or Spring: variables, operators, control flow, and the four OOP pillars. If you can't explain these, nothing later in the roadmap will make sense.",
    subtopics: [
    ...
    mini: { title: 'Checkpoint Project — Command-Line Grade Calculator', desc: 'A console program that reads student scores, uses control flow to assign letter grades, and models Student/Course with a small class hierarchy — variables, operators, and OOP pillars only, no collections or streams yet.' },
  },
  {
    id: 'java-core', num: 8, phase: 1, title: 'Java Core — Collections, Streams & Concurrency',
    sub: 'Now that syntax and OOP are solid: the Collections Framework, exception handling, streams and lambdas, and the basics of multithreading.',
    subtopics: [
      ...
      { title: 'Multithreading & Concurrency Basics',
        concepts: [
          ...
          'synchronized (or a Lock) enforces mutual exclusion so only one thread touches a critical section at a time — at the cost of threads waiting on each other.',
          'wait/notify coordinate threads around a condition (producer-consumer); higher-level tools (java.util.concurrent: ExecutorService, BlockingQueue, atomics) solve the same problems with far less room for error.',
        ],
  ...
  {
    id: 'solid', num: 9, phase: 1, title: 'SOLID & Design Principles',
    ...
    subtopics: [
      ...
      { title: 'Design Patterns',
        concepts: [
          ...
          'Creational patterns (Singleton, Factory) control object creation; structural (Adapter, Decorator) compose objects; behavioral (Strategy, Observer) manage communication between them.',
  ...
  {
    id: 'build-tools', num: 10, phase: 1, title: 'Build Tools — Maven & Gradle',
  ...
  {
    id: 'git', num: 11, phase: 1, title: 'Version Control — Git',
  ...
  },
  {
    ...
    subtopics: [
      ...
      { title: 'Querying — JPQL, Criteria, Native',
        concepts: [
          ...
          'Native queries drop to raw SQL when JPQL can\'t express what you need (vendor-specific functions, complex window queries) — use sparingly, since they break the database-portability JPA otherwise gives you.',
        ],
        q: [
    ...
    subtopics: [
      { title: 'Unit Testing with JUnit & Mockito',
        concepts: [
          ...
          'Mockito\'s verify() checks that a dependency was actually called the way you expect, not just that the final result looked right.',
        ],
        q: [
      ...
      { title: 'Integration Testing',
        concepts: [
          ...
          'MockMvc drives a controller through simulated HTTP requests without starting a real server, verifying routing, serialization, and status codes together.',
