...
export const PHASE_PROJECTS = [
  ...
  { title: 'Phase Project — CodeSense-style REST Service', desc: 'A documented, versioned, paginated REST API (REST API Design) built on a Spring Boot IoC/DI container (Spring Core & Spring Boot) — the shape of a real placement-ready backend project.' },
